...
public class EvaluationServiceTest extends CaliberTest {
	...
	/**
	 * @see com.revature.caliber.services.EvaluationService#checkIfTraineeShouldBeFlagged(Note
	 *      note)
	 */
	@Test
	 ...
	 * Test methods:
	 * 
	 * @see com.revature.caliber.services.EvaluationService#findGradesByWeek(Integer,
	 *      Integer)
	 * 
	 */
	@Test
...
/*		// get test batch
		...
		// get grades
		Map<Integer, List<Grade>> grades = evaluationService.findGradesByWeek(batch.getBatchId(), TEST_ASSESSMENT_WEEK);
	 ...
	 * Test methods:
	 * 
	 * @see com.revature.caliber.services.EvaluationService#findIndividualNotes(Integer,
	 *      Integer)
	 */
	@Test
...
*/
	...
	public void calculateAverageNullBatchId() {
		...
		// A null batch id will not throw an exception so the assert below will be hit
		// meaning that we are properly handling null batch ids
		assertEquals(1, 1);
	}
}
